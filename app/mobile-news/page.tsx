...
export const metadata = { title: 'Mobile News', description: 'Latest smartphone launches, leaks and announcements for India' }
    ...
    <div>
      <div className="bg-red-700 text-white py-10 px-4">
        <div className="container mx-auto">
          <h1 className="text-4xl font-black mb-2">📱 Mobile News</h1>
          <p className="text-red-200">Latest smartphone launches, leaks and announcements for India</p>
        </div>
      </div>
          ...
          <>
            ...
            {articles.length === limit && (
              <div className="text-center mt-10">
                <Link
                  href={`/mobile-news?${brand ? `brand=${brand}&` : ''}page=${page + 1}`}
