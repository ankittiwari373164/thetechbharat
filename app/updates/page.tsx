...
export const metadata = { title: 'Updates', description: 'Latest software and firmware updates for Indian users' }
    ...
    <div>
      <div className="bg-red-700 text-white py-10 px-4">
        <div className="container mx-auto">
          <h1 className="text-4xl font-black mb-2">🔄 Updates</h1>
          <p className="text-red-200">Latest software and firmware updates for Indian users</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex gap-2 overflow-x-auto pb-3 mb-8">
          ...
          {BRANDS.map(b => (
            <Link key={b} href={`/updates?brand=${b}`}
          ...
          <>
            ...
            {articles.length === limit && (
              <div className="text-center mt-10">
                <Link
                  href={`/updates?${brand ? `brand=${brand}&` : ''}page=${page + 1}`}
