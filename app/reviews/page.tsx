...
export const metadata = { title: 'Reviews', description: 'In-depth smartphone reviews for Indian buyers' }
    ...
    <div>
      <div className="bg-red-700 text-white py-10 px-4">
        <div className="container mx-auto">
          ...
          <p className="text-red-200">In-depth smartphone reviews for Indian buyers</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex gap-2 overflow-x-auto pb-3 mb-8">
          ...
          {BRANDS.map(b => (
            <Link key={b} href={`/reviews?brand=${b}`}
          ...
          <>
            ...
            {articles.length === limit && (
              <div className="text-center mt-10">
                <Link
                  href={`/reviews?${brand ? `brand=${brand}&` : ''}page=${page + 1}`}
